...
define( 'WPCACHEHOME', '/home/y/yush25um/yush25um.bget.ru/public_html/wp-content/plugins/wp-super-cache/' );
define('DB_NAME', 'gb_5dimansion');

/** Имя пользователя MySQL */
define('DB_USER', 'gb_5dimansion');

/** Пароль к базе данных MySQL */
define('DB_PASSWORD', 'z38z4acc2nm');

/** Имя сервера MySQL */
define('DB_HOST', 'mysql95.1gb.ru');
