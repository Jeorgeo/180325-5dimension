<?php
/**
 * Template Name: Услуги и предложения SEO
 *
...
<main class="content-area">
	<section class="service seo-service box-1">
		<div class="container">
...
Нелли Давыдова, лично свяжусь с вами в ближайшее рабочее время.</p>
					...
					<div class="cols col-5 bottom-form col-md-6">
						<form class="cloud-form order-form" method="post">
							...
							<button id="submit" class="cloud-form__submit" type="submit" name="submit" onclick="yaCounter39506875.reachGoal('ORDER12'); return true;">
								Отправить заявку
							</button>
