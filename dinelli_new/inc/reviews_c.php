...
add_action( 'init', 'register_cpt_reviews_c' );
function register_cpt_reviews_c() {
	...
	$labels = array(
		...
		'menu_name' => __( 'Отзывы после консультации', 'reviews_text' ),
	);
	...
	register_post_type( 'reviews_c', $args );
}
